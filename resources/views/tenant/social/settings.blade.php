...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        <h1 class="h4 mb-1">Instagram</h1>
        <p class="text-muted small mb-0">Conecte sua conta e publique no Instagram via integracao com OpenCart.</p>
    </div>
</div>
...
<div class="row g-4">
        ...
        <div class="card h-100">
            <div class="card-body p-4">
                <h5 class="card-title mb-4">
                    <i class="bi bi-plug me-2 text-primary"></i>Status da Conexao
                </h5>
                ...
                @if($metaToken)
                    <div class="d-flex align-items-center gap-3 mb-4 p-3 bg-light rounded-3">
                        ...
                        @else
                            <span class="badge bg-warning text-dark">Nao vinculado</span>
                        @endif
                    </div>
                    ...
                    @if(! $metaToken->hasInstagram())
                        <div class="alert alert-warning small mb-4">
                            ...
                            O Instagram nao foi detectado. Verifique se a conta e Profissional/Criador e refaca a conexao.
                        </div>
                    @endif
                    ...
                    @if(!empty($instagramProfile['biography']))
                        <div class="small text-muted mb-3"><strong>Bio:</strong> {{ $instagramProfile['biography'] }}</div>
                    @endif

                    <form method="POST" action="{{ route('meta.disconnect') }}" onsubmit="return confirm('Deseja desconectar a conta Instagram?')">
                        @csrf
                        @method('DELETE')
                ...
                @else
                    <div class="text-center py-4">
                        ...
                        <p class="text-muted mb-4">Nenhuma conta conectada. Conecte para comecar a publicar no Instagram.</p>
                        <a href="{{ route('meta.redirect') }}" class="btn btn-primary btn-lg px-4">
                            <i class="bi bi-instagram me-2"></i>Conectar com Instagram
                        </a>
                    </div>
                @endif
            </div>
    ...
    <div class="col-lg-6">
        <div class="card h-100">
            <div class="card-body p-4">
                ...
                <div class="p-3 rounded-3 text-center" style="background:linear-gradient(45deg,#f09433,#bc1888);">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <p class="text-muted small">
                    Selecione uma imagem. Ela sera salva no storage publico, convertida para JPG e enviada para o Instagram conectado.
                </p>
                ...
                <form method="POST" action="{{ route('meta.social.manual-publish') }}" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="form-text">Formatos aceitos: JPG, JPEG, PNG, WEBP, GIF, BMP (max. 10MB). O sistema converte para JPG automaticamente.</div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Legenda</label>
                            <textarea name="caption" class="form-control" rows="4" maxlength="2200" placeholder="Legenda da publicacao (opcional)"></textarea>
                        </div>
                        <input type="hidden" name="platforms[]" value="instagram">
                        <div class="col-12"><div class="small text-muted">Destino: Instagram</div></div>
                        <div class="col-12">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body p-4">
                <h5 class="card-title mb-4">
                    <i class="bi bi-clock-history me-2 text-primary"></i>Publicacoes Recentes
                </h5>
...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        <h1 class="h4 mb-1">Instagram</h1>
        <p class="text-muted small mb-0">Conecte sua conta e publique no Instagram via integração com OpenCart.</p>
    </div>
</div>
            ...
            <div class="card-body p-4">
                ...
                @if($metaToken)
                    ...
                    <form method="POST" action="{{ route('meta.disconnect') }}"
                          onsubmit="return confirm('Deseja desconectar a conta Instagram?')">
                        @csrf @method('DELETE')
                        <button class="btn btn-outline-danger w-100">
                            <i class="bi bi-x-circle me-2"></i>Desconectar conta
                        </button>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="caption" class="form-control" rows="4" maxlength="2200"
                                      placeholder="Legenda da publicacao (opcional)"></textarea>
                        </div>
                        <input type="hidden" name="platforms[]" value="instagram">
                        <div class="col-12">
                            <div class="small text-muted">Destino: Instagram</div>
                        </div>
                        <div class="col-12">
                            <button class="btn btn-primary">
                                <i class="bi bi-send me-2"></i>Publicar agora
